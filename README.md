...
```
#### [Job.xml](https://github.com/ZenryokuService/TextRPG/wiki/%E8%81%B7%E6%A5%AD%E5%AE%9A%E7%BE%A9%E3%81%AB%E9%96%A2%E3%81%97%E3%81%A6)(職業カスタム)
＜作成者が決めるところ＞
職業、勇者の職業IDは「BRV」とする。各種IDは3文字で示すようにしている。など作成する世界観と合わせて設定を作成

＜テキストRPGの仕様＞
各カテゴリの要素として共通するものがある。ID, NAME、IMGがそれにあたる。
imgタグで画像を指定することができる。指定しなくてもよい。※必須ではない
